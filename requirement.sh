...
packages=(git-all ruby-full build-essential zlib1g-dev dotnet-sdk-8.0 r-base octave clisp rustc freeglut3-dev mysql-server)
...
sudo mv /home/kodingwindow/chromedriver /usr/bin
sudo chmod +x /usr/bin/chromedriver
sudo mv /home/kodingwindow/geckodriver /usr/bin
